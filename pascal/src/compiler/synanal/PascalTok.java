...
public class PascalTok {
  ...
  static final int function = 29;
  static final int procedure_head = 25;
  static final int loop = 34;
  static final int infix = 14;
  static final int parameter_desc = 28;
  static final int type_desc = 17;
  static final int function_head = 30;
  static final int type_table = 19;
  static final int type_record_component = 22;
  static final int parameter_call = 16;
  static final int type_atom = 18;
  static final int statement_ = 32;
  static final int type_record = 20;
  static final int conditional = 33;
  static final int source = 0;
  static final int subroutine = 11;
  static final int type_pointer = 23;
  static final int var = 8;
  static final int statement = 31;
  static final int eps = 35;
  static final int constant = 4;
  static final int procedure = 24;
  static final int subroutine_call = 15;
  static final int parameter = 27;
  static final int prefix = 13;
  static final int type_record_components = 21;
  static final int block_statement = 3;
  static final int value = 12;
  static final int parameters = 26;
  static final int one_var = 10;
