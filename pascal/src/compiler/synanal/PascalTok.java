...
public class PascalTok {
  ...
  /* non terminals */
  static final int type_record = 16;
  static final int type_atom = 14;
  static final int var_ = 9;
  static final int declaration = 2;
  static final int type_record_component = 18;
  static final int constant = 4;
  static final int type = 6;
  static final int parameter = 23;
  static final int function = 25;
  static final int parameters = 22;
  static final int procedure = 20;
  static final int program = 1;
  static final int type_record_components = 17;
  static final int constant_ = 5;
  static final int sentence = 3;
  static final int type_pointer = 19;
  static final int source = 0;
  static final int value = 11;
  static final int function_head = 26;
  static final int parameter_desc = 24;
  static final int type_desc = 13;
  static final int prefix = 12;
  static final int procedure_head = 21;
  static final int subroutine = 10;
  static final int var = 8;
  static final int type_ = 7;
  static final int type_table = 15;
}
