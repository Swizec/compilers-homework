...
public class PascalTok {
  ...
  /* non terminals */
  static final int type_record = 19;
  static final int type_atom = 17;
  static final int var_ = 9;
  static final int declaration = 2;
  static final int statement = 30;
  static final int type_record_component = 21;
  static final int constant = 4;
  static final int type = 6;
  static final int parameter = 26;
  static final int statement_ = 31;
  static final int function = 28;
  static final int parameters = 25;
  static final int procedure = 23;
  static final int program = 1;
  static final int type_record_components = 20;
  static final int constant_ = 5;
  static final int subroutine_call = 14;
  static final int type_pointer = 22;
  static final int source = 0;
  static final int value = 11;
  static final int function_head = 29;
  static final int parameter_desc = 27;
  static final int conditional = 32;
  static final int type_desc = 16;
  static final int prefix = 12;
  static final int block_statement = 3;
  static final int parameter_call = 15;
  static final int infix = 13;
  static final int procedure_head = 24;
  static final int subroutine = 10;
  static final int var = 8;
  static final int loop = 33;
  static final int type_ = 7;
  static final int type_table = 18;
}
